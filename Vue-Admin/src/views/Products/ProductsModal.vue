                    ...
                    <TransitionChild as="template" enter="duration-300 ease-out" enter-from="opacity-0 scale-95"
                        ...
                        <DialogPanel
                            ...
                            <div class="col-span-2 px-4 pt-5 pb-4">
                                ...
                                <CustomInput type="file" class="mb-2" @change="(file) => (product.image = file)"
                                    label="Product image" />
                            ...
                            <footer class="bg-gray-50 rounded-b-lg px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                                ...
                                <button type="button"
                                    ...
                                    ref="cancelButtonRef" @click="closeModal">
                                    Cancel
                                </button>
                            </footer>
                        </DialogPanel>
...
import { useProductStore } from "Vue-Admin/src/stores/products";
import {
    TransitionRoot,
    TransitionChild,
    Dialog,
